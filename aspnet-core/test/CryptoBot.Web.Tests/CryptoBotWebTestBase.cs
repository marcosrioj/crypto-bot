...
{
    public abstract class CryptoBotWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CryptoBotWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CryptoBotWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CryptoBotDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CryptoBotDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CryptoBotDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CryptoBotDbContext, Task<T>> func)
        {
            T result;
