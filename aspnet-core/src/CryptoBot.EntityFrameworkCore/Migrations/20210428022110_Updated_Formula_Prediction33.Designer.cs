...
namespace CryptoBot.Migrations
{
    ...
    [Migration("20210428022110_Updated_Formula_Prediction33")]
    partial class Updated_Formula_Prediction33
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.Formula", b =>
                {
                    ...
                    b.Property<int>("LimitOfBookOrders")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.Robot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.Order", b =>
                {
                    b.HasOne("CryptoBot.Crypto.Entities.Order", "OriginOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.Robot", b =>
                {
                    b.HasOne("CryptoBot.Crypto.Entities.Formula", "Formula")
                        .WithMany()
