...
namespace CryptoBot.Migrations
{
    ...
    [Migration("20210328154153_Updated_ComparativeHistoricalDetail")]
    partial class Updated_ComparativeHistoricalDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.ComparativeHistorical", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ComparativeHistoricals");
                });

            modelBuilder.Entity("CryptoBot.Crypto.Entities.ComparativeHistoricalDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ComparativeHistoricalId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CryptoBot.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CryptoBot.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CryptoBot.Crypto.Entities.ComparativeHistoricalDetail", b =>
                {
                    b.HasOne("CryptoBot.Crypto.Entities.ComparativeHistorical", "ComparativeHistorical")
                        .WithMany("Details")
                        .HasForeignKey("ComparativeHistoricalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ComparativeHistorical");
                });
